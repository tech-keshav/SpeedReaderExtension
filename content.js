// Content Script for Speed Reader Extension
// This script handles the text highlighting functionality

// Wrap everything in an IIFE to prevent variable pollution
(function() {
    'use strict';
